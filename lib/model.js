...
export function emptyPT() {
  return {
    contacto: emptyContacto(),
    general: { actividadEconomica: "", periodoEvaluar: "", ingresosPeriodo: "", utilidadPeriodo: "", valorPatrimonio: "" },
    consideraciones: {
      numPartesVinculadas: "",
      opDomiciliadas: null,
      ...
      consolidaEEFF: null,
      testBeneficio: null,
      cotizarInformeLocal: false,
      cotizarInformeMaestro: false,
      cotizarInformePaisPorPais: false,
      cotizarDeclaracionInformativa: false,
    },
