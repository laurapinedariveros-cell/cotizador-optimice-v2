...
export default function RevisoriaForm({ data, setData }) {
  ...
  return (
    <>
      ...
      <Card title="Situación fiscal" eyebrow="Sección 2" pct={sectionCompleteness(data.fiscal)}>
      ...
      <Card title="Personal" eyebrow="Sección 3" pct={sectionCompleteness(data.personal)}>
        <div className="op-grid2">
      ...
      <Card title="Información administrativa y financiera" eyebrow="Sección 4" pct={sectionCompleteness(data.financiera)}>
