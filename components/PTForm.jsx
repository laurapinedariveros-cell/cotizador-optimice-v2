    ...
    <>
      <Card title="Información general" eyebrow="Sección 1" pct={sectionCompleteness(data.general)}>
        <div className="op-grid2">
          ...
          <Field label="Valor de activos"><input type="number" className="op-input" value={data.general.valorActivos} onChange={(e) => set("general", { valorActivos: e.target.value })} /></Field>
        </div>
      </Card>
