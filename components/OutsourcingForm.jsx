    ...
    <>
      <Card title="Tamaño y operación" eyebrow="Sección 1" pct={sectionCompleteness(data.operacion)}>
        ...
        <Field label="Origen de los ingresos">
          <select className="op-select" value={data.operacion.origenIngresos} onChange={(e) => set("operacion", { origenIngresos: e.target.value })}>
            <option value="">Seleccionar…</option>
            <option value="Nacionales">Nacionales</option>
            <option value="Extranjeros">Extranjeros</option>
            <option value="Ambas">Ambas (nacionales y extranjeros)</option>
          </select>
        </Field>
      </Card>
