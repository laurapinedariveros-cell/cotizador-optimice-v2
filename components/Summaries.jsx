    ...
    <>
      ...
      <div className="op-doc-section">
        ...
        <div className="op-doc-row">
          ...
          {doc.camaraComercioUrl ? (
            <a href={doc.camaraComercioUrl} target="_blank" rel="noopener noreferrer" className="a" style={{ color: "var(--green-dark)" }}>Ver archivo</a>
          ) : (
        ...
        <div className="op-doc-row">
          ...
          {doc.estadosFinancierosUrl ? (
            <a href={doc.estadosFinancierosUrl} target="_blank" rel="noopener noreferrer" className="a" style={{ color: "var(--green-dark)" }}>Ver archivo</a>
          ) : (
            <span className="a empty">Sin diligenciar</span>
          )}
        </div>
