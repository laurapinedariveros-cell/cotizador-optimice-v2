...
export function PTSummary({ data }) {
  ...
  const queCotizar = [
    c.cotizarInformeLocal && "Informe Local",
    c.cotizarInformeMaestro && "Informe Maestro",
    c.cotizarInformePaisPorPais && "Informe País por País",
    c.cotizarDeclaracionInformativa && "Declaración informativa de precios de transferencia",
  ].filter(Boolean).join(" · ");
  return (
    <>
      <ContactoSummary data={data.contacto} />
      <div className="op-doc-section">
        ...
        <Row q="Ingresos del periodo" a={g.ingresosPeriodo} />
        <Row q="Utilidad del periodo" a={g.utilidadPeriodo} />
        <Row q="Valor de patrimonio" a={g.valorPatrimonio} />
      </div>
      <div className="op-doc-section">
        ...
        <Row q="¿Qué le gustaría cotizar?" a={queCotizar || "(sin seleccionar)"} />
      </div>
      <div className="op-doc-section">
