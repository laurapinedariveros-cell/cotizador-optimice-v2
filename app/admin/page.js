...
import { RevisoriaSummary, PTSummary, OutsourcingSummary, ActivosFijosSummary, ExistenciasSummary, AuditoriaSummary, ConstitucionSummary, DueDiligenceSummary } from "../../components/Summaries";
      ...
      {selected && (
        <div className="op-doc-wrap">
          <div className="op-doc">
            ...
            {selected.tipo === "activosFijos" && <ActivosFijosSummary data={selected.data} />}
            {selected.tipo === "existencias" && <ExistenciasSummary data={selected.data} />}
            {selected.tipo === "auditoria" && <AuditoriaSummary data={selected.data} />}
            {selected.tipo === "constitucion" && <ConstitucionSummary data={selected.data} />}
            {selected.tipo === "dueDiligence" && <DueDiligenceSummary data={selected.data} />}
          </div>
        </div>
      )}
    </div>
