...
export default function ClientPage() {
  ...
  return (
    <div className="op-root">
      ...
      {view === "hero" && (
        <div className="op-landing" style={{ maxWidth: 620 }}>
          ...
          <p style={{ fontStyle: "italic", color: "var(--ink-soft)", fontSize: 13.5, marginBottom: 14 }}>
            Menos trámites para cotizar. Más tiempo para conocerte y entender tu negocio.
          </p>
